...
# USAGE: sh AlignReads.sh -o ${SCR}/longipalpis_ms/map2male -r /nas/longleaf/home/astuck/longipalpis_ms/Lutzomyia_longipalpis_male_1.0.fa -s /nas/longleaf/home/astuck/longipalpis_ms/samples2use.noheader.tsv -j 3
